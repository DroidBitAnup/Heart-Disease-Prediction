...
with tab1:
    age = st.number_input("Age (years)", min_value=0, max_value=90)
    ...
    algonames = ['Decision Trees','Logistic Regression','Support Vector Machine','Random Forest','KNN','XGBoost']
    modelnames = ['Tree.pkl', 'LogisticR.pkl','SVM.pkl','RandomForest.pkl','KNN.pkl','XGBoost.pkl']
...
with tab3:
    ...
    data = {'Decision Trees': 80.97, 'Logistic Regression' : 85.86, 'Random Forest': 84.23, 'Support Vector Machine':84.23,'Random Forest':86.95,'KNN':72.28,'XGBoost':86.97}
